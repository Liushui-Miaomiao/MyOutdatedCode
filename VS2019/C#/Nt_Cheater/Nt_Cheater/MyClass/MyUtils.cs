...
namespace Nt_Cheater {
	...
	public delegate void CallBack_int(int pid);
	/// <summary>
	/// 一个IntPtr类型无返回值的回调函数
	/// </summary>
	/// <param name="pid"></param>
	public delegate void CallBack_IntPtr(IntPtr baseAddr);
	...
	class MyUtils {
		...
		/// <param name="fail">失败回调</param>
		public static void GetPidByProcessName(string processName, CallBack_int success = null, CallBack fail = null) {
		...
		/// <param name="fail">失败回调</param>
		public static void GetProcessBaseAddr(string processName, CallBack_IntPtr success = null, CallBack fail = null) {
